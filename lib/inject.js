...
/******/ 	"use strict";
    ...
    const addGPTButtonRandom = (toolbarEl, onClick) => {
        ...
        gptIconWrapper.onclick = async () => {
            ...
            // Select a random tweet type from the tweetTypes array
    ...
    // This function can be optimized further, but in most cases, the common container is just 2-3 levels higher in the DOM tree.
